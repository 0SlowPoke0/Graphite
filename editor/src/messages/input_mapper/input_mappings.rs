...
pub fn input_mappings() -> Mapping {
	...
	let mappings = mapping![
		...
		//
		// PenToolMessage
		entry!(PointerMove; refresh_keys=[Control, Alt, Shift], action_dispatch=PenToolMessage::PointerMove { snap_angle: Shift, break_handle: Alt, lock_angle: Control, drag_anchor_and_handle:Space}),
